          ...
          <div className="flex items-center justify-around px-2 py-3">
            ...
            <button 
              ...
              className={cn(
                ...
                activeTab === 'resources' ? "text-blue-500" : "text-gray-600"
              )}
            >
            ...
            <button 
              ...
              className={cn(
                "flex flex-col items-center gap-1 px-4 py-2 -mt-6 bg-gradient-to-r from-orange-400 to-orange-500 rounded-full shadow-lg transition-transform hover:scale-105",
            ...
            <button 
              ...
              className={cn(
                "flex flex-col items-center gap-1 px-3 py-1 transition-colors",
                activeTab === 'assessments' ? "text-blue-500" : "text-gray-600"
              )}
            >
            ...
            <button 
              ...
              className={cn(
                "flex flex-col items-center gap-1 px-3 py-1 transition-colors",
                activeTab === 'lessons' ? "text-blue-500" : "text-gray-600"
              )}
            >
