          ...
          {activeMenu === "reports" && (
            <div className="p-8">
              <div className="flex flex-col items-center justify-center min-h-[70vh] relative">
                ...
                {/* Main content */}
                <div className="relative z-10 flex flex-col items-center max-w-2xl mx-auto px-4 space-y-10">
                  {/* Icon with glow effect */}
                  <div className="relative">
                    <div className="absolute inset-0 bg-primary/20 rounded-full blur-2xl animate-pulse"></div>
                    <div className="relative bg-gradient-to-br from-primary/10 to-primary/5 p-8 rounded-3xl border border-primary/20 shadow-xl">
                  ...
                  <div className="text-center space-y-6">
                    ...
                    <p className="text-lg text-muted-foreground leading-relaxed max-w-xl">
                      We're crafting a comprehensive analytics dashboard to help you track your learning journey with detailed insights and personalized progress metrics.
                    </p>
                  </div>

                  {/* Feature preview cards */}
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full mt-8">
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-5 hover:shadow-lg hover:border-primary/30 transition-all duration-300">
                      ...
                      <p className="text-sm text-muted-foreground">Track your scores and improvement trends</p>
                    </div>
                    ...
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-5 hover:shadow-lg hover:border-primary/30 transition-all duration-300">
                      ...
                      <h3 className="font-semibold text-foreground mb-1">Learning Insights</h3>
                      <p className="text-sm text-muted-foreground">Discover your strengths and focus areas</p>
                    </div>
                    ...
                    <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-5 hover:shadow-lg hover:border-primary/30 transition-all duration-300">
                      ...
                      <p className="text-sm text-muted-foreground">Earn rewards for your progress</p>
                    </div>
                  </div>
                  ...
                  <div className="w-full max-w-md mt-6">
                    ...
                    <div className="w-full h-2 bg-muted rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-primary to-primary/70 rounded-full transition-all duration-1000 ease-out" style={{ width: '75%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
